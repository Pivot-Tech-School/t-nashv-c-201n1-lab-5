...
and the second element is a concatenated string that EXACTLY follows this example and 
...
let sum2 = sum(aPlusB, c)[0]

let aTimesB = multiply(a, b)[0]
let product2 = multiply(aTimesB, c)[0]

let message1 = a + ', ' + b + ', and ' + c + ' sum to ' + sum2 + '.'
let message2 = 'The product of ' + a + ', ' + b + ', and ' + c + ' is ' + product2 + '.'
return [sum2, product2, message1, message2]
}
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    totalArray[0] = finalSum;
    // string
    totalArray[1] = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${finalSum} is their sum.`;
    //return array
return totalArray
}
...
function multiplyArray(multArr) { //eslint-disable-line
    let productArray = [];
    // product of first 2 values
    let aTimesB = multiply((multArr[0]),(multArr[1]))
    aTimesB = aTimesB [0]
    let finalProd = multiply(aTimesB, multArr[2])[0];
    productArray [0] = finalProd;
    // string
    productArray [1]= `The numbers ${multArr[0]}, ${multArr[1]}, ${multArr[2]} have a product of ${finalProd}.`;
    return productArray; 
}
