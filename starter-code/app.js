...
//     let sumMultiply = a * b
//     let message = 'The product of ' + a + ' and ' + b + ' is ' + sumMultiply
//     return [sumMultiply, message]
// }
...
//     let addSum = 16
//     let multiProduct = 140
//     let message = a + ' and ' + b + ' and ' + c + ' is ' + addSum + '.'
//     let message2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiProduct + '.'
//     return [message2]
// }
...
function sumArray(a, b, c) { //eslint-disable-line
    let totalArray = 9
    let message = testArray + ' was passed in an array of numbers, and ' + totalArray + ' is their sum. '
    return [message]
}
